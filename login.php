    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .auth-card {
            ...
            backdrop-filter: blur(15px); /* Shishe jaisa blur */
            padding: 50px 40px;
            border-radius: 20px;
...
<body>
    ...
    <<div class="auth-card">
    <h2>Welcome Back</h2>
    <p class="subtitle">Enter the realm of exquisite taste.</p>

    <!-- 1. Form tag zaroori hai -->
    <form action="save_login.php" method="POST">
        <div class="input-group">
            <label>Email Address</label>
            <!-- 2. 'name' attribute se PHP data pehchanti hai -->
        ...
        <!-- 3. Is button par click ab kaam karega -->
        <button type="submit" class="btn-auth">Log In</button>
    </form>
    
    <p class="switch-auth">Don't have an account? <a href="sign.php">Sign up</a></p>
    ...
    <script>
        function handleLogin(e) {
            e.preventDefault();
            // Yahan actual login logic aayegi
            alert("Aapka swagat hai! Luxe Table par aapki shaam yaadgar banegi.");
